/* ./src/Icon.html generated by Svelte v2.15.3 */

function viewBox(props) {
  return "0 0 " + props.icon.icon[0] + " " + props.icon.icon[1]
};

function classes(props) {
  var classes = "fa-svelte "
  if(props.class) {
...
Icon.prototype._recompute = function _recompute(changed, state) {
	if (this._differs(state.viewBox, (state.viewBox = viewBox(exclude(state, "viewBox"))))) changed.viewBox = true;
	if (this._differs(state.classes, (state.classes = classes(exclude(state, "classes"))))) changed.classes = true;
	if (this._differs(state.path, (state.path = path(exclude(state, "path"))))) changed.path = true;
}
